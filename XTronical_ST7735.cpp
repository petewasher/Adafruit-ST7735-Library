/***************************************************
  This is a library for generic 1.44" 128x128pixel SPI colour displays.

  This library should work with most TFT LCDs with the ST7735 driver chip
  Source code and tutorials on wiring these screens up can be found at
  www.xtronical.com or search for the XTronical channel on youtube
  
  This code is based upon the original code from Adafruit Industries and
  should be used in conjunction with their core graphics library Adafruit_GFX.h
  
  Written by XTronical August 2017
  Original header comments from Adafruit now follow:
...
// Initialization 
void Adafruit_ST7735::init(void) {
  commonInit(Rcmd1); 
